...
metric_beegfs_ctl_runtime="# HELP beegfs_ctl_runtime how long it took to run a beegfs-ctl commmand
# TYPE beegfs_ctl_runtime gauge
beegfs_ctl_runtime{beegfs_cluster=\"${cluster}\","

# output thorium.mgmt.<nodename>.reachability metric
# 
...
function check_mgmt_service
{
  ...
  echo "${metric_beegfs_ctl_runtime}nodetype=\"mgmt\",cmd=\"listnodes\"} ${runtime}" >> ${textfile_dir}/beegfs_${hostn}.tmp
...
function check_mirrored_service
{
  ...
  #============= ============ ========     ============  ===========        =====         ====    =      ======       =====    =   ======
  #            11      primary       21          Offline         Good     662.9GiB     531.7GiB  80%     1327.4M     1064.3M  80%   beegfs-meta thorium-meta-21 [ID: 21]
  #            11    secondary       11          Offline         Good     662.9GiB     531.8GiB  80%     1327.4M     1064.3M  80%   beegfs-meta thorium-meta-11 [ID: 11]
