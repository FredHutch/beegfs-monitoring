...
function _uid_lookup
{
  ...
  999)
    ...
    ;;
  5042)
    username="hutchbase_svc"
    ;;
  5075)
    username="sullivanlab"
    ;;
  5133)
    username="marmoset-svc"
    ;;
  5203)
    username="svc_keyencebzx800"
    ;;
  6301)
    username="cdradmin"
    ;;
  ...
  8031)
    ...
    ;;
  8864)
    username="vectramultiplex"
    ;;
  9020)
    username="emsr"
    ;;
  9277)
    username="smrtanalysis"
    ;;
  9403)
    username="jblab01"
    ;;
